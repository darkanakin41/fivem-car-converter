...
folder = 'migration'
project_name = 'alticarp-migration'
executable = 'alticar-migration'
...
args = dict(name='darkanakin41-{}'.format(project_name),
            version=version,
            description='{} - A set of tools for project management !'.format(project_name),
            ...
            keywords='project toolbox project-toolbox',
